...
from app.assembler.expr import AssignExpr, LiteralExpr, VariableExpr
from app.assembler.statement import BlockStmt, ExpressionStmt, PrintStmt, VarStmt
...
from app.executor.executor import Environment, Executor
...
class TestCheckerComputesDistance:
    ...
    def test_for_loop_scope_counts_as_one_level_for_variables_used_in_body(self):
        ...
        from app.assembler.expr import BinaryExpr
        from app.assembler.statement import ForStmt
